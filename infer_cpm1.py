...
def main():
    ...
    if args.split == 'trial':
        ...
        dataset = json.load(open(os.path.join(args.data_dir, 'cmrc2018_dev.json'), 'r'))
        fout = open(os.path.join(args.save_dir, f'cmrc2018_dev_pred_{args.output_name}.json'), 'w')
