...
LOADS="webgpt_bs64_epoch5_past_view-best.pt"

# webgpt_bs64_epoch5_past_view-best.pt
...
CMD="python3 -m torch.distributed.launch ${DISTRIBUTED_ARGS} ${BASE_PATH}/examples/cpm1/finetune_cpm1_webgpt_eval.py ${OPTS}"
echo ${CMD}

CUDA_VISIBLE_DEVICES=0 ${CMD} 2>&1 | tee ${BASE_PATH}/logs/cpm1/${LOAD}.log
